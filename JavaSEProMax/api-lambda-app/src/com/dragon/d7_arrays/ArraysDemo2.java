...
//                return 0;
                //return o1 - o2; //默认是升序
//                return -(o1 - o2);//负数是降序，或者可以写成 o2 - o1
        ...
        System.out.println(Arrays.toString(students)); //三个对象地址
        ...
        Arrays.sort(students, new Comparator<Student>() {
            ...
            public int compare(Student o1, Student o2) {
                ...
                //return 0;
                //如果是double小数排序，需要使用官方提供的Double.compare()
                //比较浮点数可以这样写
                //return Double.compare(o1.getHeight() , o2.getHeight());//升序
                return Double.compare(o2.getHeight() , o1.getHeight());//升序
